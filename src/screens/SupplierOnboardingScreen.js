...
const styles = StyleSheet.create({
  ...
  dotNum: { fontSize: 12, fontWeight: '700', color: '#94A3B8', fontFamily: 'Geist_700Bold'},
  dotNumActive: { color: '#fff' },
  line: { flex: 1, height: 2, backgroundColor: '#E2E8F0' },
  lineDone: { backgroundColor: '#16A34A' },
  stepLabel: { fontSize: 12, color: '#94A3B8', fontWeight: '600', fontFamily: 'Geist_600SemiBold'},
  ...
  stepTitle: { fontSize: 20, fontWeight: '800', color: '#111', letterSpacing: -0.4, marginBottom: 4, fontFamily: 'Geist_700Bold'},
  stepSubtitle: { fontSize: 13, color: '#6B7280', lineHeight: 19, fontFamily: 'Geist_400Regular'},
  field: { marginBottom: 18 },
  fieldLabel: { fontSize: 13, fontWeight: '700', color: '#374151', marginBottom: 6, fontFamily: 'Geist_700Bold'},
  fieldHint: { fontSize: 11, color: '#9CA3AF', marginBottom: 6, marginTop: -2, fontFamily: 'Geist_400Regular'},
  input: {
  ...
  doneLabel: { fontSize: 13, color: '#9CA3AF', fontWeight: '600', fontFamily: 'Geist_600SemiBold'},
  doneValue: { fontSize: 13, color: '#111', fontWeight: '600', flex: 1, textAlign: 'right', fontFamily: 'Geist_600SemiBold'},
  tipsCard: {
    backgroundColor: '#EFF6FF', borderRadius: 14,
    padding: 16, borderWidth: 1, borderColor: '#BFDBFE',
  },
  tipsTitle: { fontSize: 13, fontWeight: '700', color: '#1E3A5F', marginBottom: 10, fontFamily: 'Geist_700Bold'},
  tipRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginBottom: 8 },
  tipDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: BLUE_DARK, marginTop: 6 },
  tipText: { fontSize: 13, color: '#374151', flex: 1, lineHeight: 19, fontFamily: 'Geist_400Regular'},
  bottomBar: {
    paddingHorizontal: 20, paddingVertical: 14,
  ...
  nextBtnText: { color: '#fff', fontSize: 16, fontWeight: '700', fontFamily: 'Geist_700Bold'},
});
