...
const styles = StyleSheet.create({
  ...
  applicantInitial: { fontSize: 20, fontWeight: '800', color: BLUE_DARK, fontFamily: 'Geist_700Bold'},
  applicantInfo: { flex: 1 },
  applicantName: { fontSize: 16, fontWeight: '700', color: '#111', marginBottom: 2, fontFamily: 'Geist_700Bold'},
  applicantEmail: { fontSize: 13, color: '#9CA3AF', marginBottom: 8, fontFamily: 'Geist_400Regular'},
  applicantMeta: { gap: 4 },
  metaItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  metaText: { fontSize: 12, color: '#6B7280', fontFamily: 'Geist_400Regular'},
  ...
  detailLabel: { fontSize: 13, color: '#9CA3AF', fontWeight: '600', minWidth: 110, fontFamily: 'Geist_600SemiBold'},
  detailValue: { fontSize: 13, color: '#111', fontWeight: '500', flex: 1, textAlign: 'right', fontFamily: 'Geist_500Medium'},
  ...
  descriptionText: { fontSize: 14, color: '#374151', lineHeight: 21, marginTop: 6, fontFamily: 'Geist_400Regular'},

  // Admin notes
  notesHint: { fontSize: 12, color: '#9CA3AF', paddingHorizontal: 16, paddingTop: 12, paddingBottom: 6, fontFamily: 'Geist_400Regular'},
  notesInput: {
    minHeight: 100,
    paddingHorizontal: 16,
    paddingBottom: 14,
  ...
  errorText: { fontSize: 14, color: '#EF4444', fontFamily: 'Geist_400Regular'},
  ...
  rejectBtnText: { color: '#fff', fontSize: 15, fontWeight: '700', fontFamily: 'Geist_700Bold'},
  approveBtn: {
    flex: 1.4,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  approveBtnText: { color: '#fff', fontSize: 15, fontWeight: '700', fontFamily: 'Geist_700Bold'},
  ...
  resolvedBarText: { fontSize: 14, fontWeight: '600', fontFamily: 'Geist_600SemiBold'},
});
