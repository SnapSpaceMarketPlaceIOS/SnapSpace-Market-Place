...
function HeartIcon({ filled = false, size = 14 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? '#67ACE9' : 'none'} stroke={filled ? '#67ACE9' : '#fff'} strokeWidth={1.2} strokeLinecap="round" strokeLinejoin="round">
